...
// splify 2.0 settings form. Status/diagnostics moved to the sibling dashboard
// (view/splify/status.js); this view is just the UCI form.Map.
...
return view.extend({
	...
	render: function (data) {
		...
		m = new form.Map('splify', _('splify'),
